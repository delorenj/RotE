...
bool IsoPrototype::init()
{
    ...
    CCMenuItemImage *pCloseItem = CCMenuItemImage::create(
                                                          ...
                                                          "CloseSelected.png",
                                                          this,
                                                          menu_selector(IsoPrototype::menuCloseCallback));
    ...
    CCLabelTTF* pLabel = CCLabelTTF::create("Rise of the Empires", "Arial", TITLE_FONT_SIZE);
    ...
    // add "IsoPrototype" splash screen"
